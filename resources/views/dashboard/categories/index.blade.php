<x-dashboard-layout title="Daftar Kategori">
                ...
                <header class="panel-heading">
                    <div class="panel-actions">
                        <div class="btn-group " aria-label="Basic example" role="group">
                            <a href="{{ route('dashboard.categories.create-form') }}" class="btn btn-outline btn-primary" aria-hidden="true">Buat Baru</a>
                        </div>
                    </div>
    ...
    <form id="frmDelete" action="{{ route('dashboard.categories.delete') }}" method="POST" style="display: none;">
        @csrf
