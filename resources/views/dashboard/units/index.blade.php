<x-dashboard-layout title="Daftar Satuan">
                ...
                <header class="panel-heading">
                    <div class="panel-actions">
                        <div class="btn-group " aria-label="Basic example" role="group">
                            <a href="{{ route('dashboard.units.create-form') }}" class="btn btn-outline btn-primary" aria-hidden="true">Buat Baru</a>
                        </div>
                    </div>
    ...
    <form id="frmDelete" action="{{ route('dashboard.units.delete') }}" method="POST" style="display: none;">
        @csrf
    ...
    <x-slot name="js">
        ...
        <script>
            ...
            let options = {
                processing: true,
                serverSide: true,
                ajax: '{{ route("dashboard.units.datatables") }}',
                order: [],
